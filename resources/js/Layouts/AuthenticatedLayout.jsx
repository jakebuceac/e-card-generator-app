                    ...
                    <div className="flex justify-center h-16">
                        ...
                        <div className="hidden sm:flex sm:absolute sm:top-0 sm:right-0 sm:items-center py-4 text-right">
                            <div className="inline-flex">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className=" mx-10 rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-semibold text-gray-500 rounded-md bg-white hover:text-gray-900 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {auth.user.name}
